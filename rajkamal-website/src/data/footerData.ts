...
export const socialPlatformsData = [
    {
        platform: 'YouTube',
        url: 'https://www.youtube.com/@RajkamalBooks',
        accounts: [
    ...
    {
        platform: 'Instagram',
        url: 'https://www.instagram.com/rajkamalbooks',
        accounts: [
    ...
    {
        platform: 'Facebook',
        url: 'https://www.facebook.com/RajkamalPrakashanSamooh',
        accounts: [
    ...
    {
        platform: 'LinkedIn',
        url: 'https://in.linkedin.com/company/rajkamalbooks',
        accounts: [
    ...
    {
        platform: 'Threads',
        url: 'https://www.threads.com/@rajkamalbooks',
        accounts: [
