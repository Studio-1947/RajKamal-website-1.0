    ...
    return (
        <div className="flex h-screen w-full overflow-hidden bg-white">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-primary items-center justify-center overflow-hidden">
                <div className="absolute inset-0 bg-gradient-to-br from-red-600 to-[#9e182e]"></div>
                
                {/* Decorative background shapes */}
                <div className="absolute top-0 left-0 w-[500px] h-[500px] bg-white opacity-5 rounded-full mix-blend-overlay filter blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
                <div className="absolute bottom-0 right-0 w-[600px] h-[600px] bg-black opacity-10 rounded-full mix-blend-overlay filter blur-3xl transform translate-x-1/3 translate-y-1/3"></div>
                ...
                <div className="relative z-10 flex flex-col items-center text-center px-12">
                    ...
                    >
                        ...
                        <p className="text-lg text-red-100/90 max-w-md mx-auto leading-relaxed">
                            Sign in to access your premium account, track your orders, and discover new publications.
                        </p>
                    </motion.div>
                </div>
            </div>
                ...
                <div className="w-full max-w-md h-full flex flex-col justify-center">
                    ...
                    <div className="text-center lg:text-left mb-8">
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            ...
                            <Link to="/signup" className="font-semibold text-primary hover:text-red-700 transition-colors">
                                Sign up here
                            </Link>
                        </p>
                    </div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-5">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-primary/20 focus:border-primary sm:text-sm transition-all duration-200 outline-none"
                            ...
                            <div className="flex items-center justify-between pt-2">
                                ...
                                <div className="text-sm">
                                    <a href="#" className="font-semibold text-primary hover:text-red-700 transition-colors">
                                        Forgot password?
                                    </a>
                                </div>
                            </div>
                        ...
                        <div className="mt-8">
                            <div className="relative">
                                ...
                                <div className="relative flex justify-center text-sm">
                                    <span className="px-3 bg-white text-gray-500 text-xs font-medium uppercase tracking-wider">Or continue with</span>
                                </div>
                            </div>
